...
class Cli {
  ...
  createTruck(): void {
    inquirer
      ...
      .then((answers) => {
        // added to debug the 9th argument the code was erroring with
        const wheels: Wheel[] = Array.from({ length: parseInt(answers.wheelCount) }, () =>
        ...
        const truck = new Truck(
          ...
          wheels // DEBUGGING WITH COPILOT FOR 9TH ARGUMENT MISSING
        );
    ...
    inquirer
      ...
      .then((answers) => {
        const motorbike = new Motorbike(
          ...
          ] // Pass an array instead of single arguments that was throwing another error
        );
